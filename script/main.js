...
const openPdfBtn3 = document.getElementById('openPdfBtn3');
const openPdfBtn4 = document.getElementById('openPdfBtn4');

openPdfBtn1.addEventListener('click', function() {
    const pdfURL1 = 'asset/images/pdf/recommandation_cogether.pdf';
    window.location.href = pdfURL1;
});

openPdfBtn2.addEventListener('click', function() {
    const pdfURL2 = 'asset/images/pdf/recommandation_jpfa.pdf';
	window.location.href = pdfURL2;
});

openPdfBtn3.addEventListener('click', function() {
    const pdfURL3 = 'asset/images/pdf/CV_developer_Web_UI_designer_Mi-Sun_JANG.pdf';
    window.location.href = pdfURL3;
});

openPdfBtn4.addEventListener('click', function() {
    const pdfURL4 = 'asset/images/pdf/CV_developer_Web_UI_designer_Mi-Sun_JANG.pdf';
    window.location.href = pdfURL4;
});
